...
####################
    ...
    #Paths between the Variables D & Y
      # Causal path: D -(+)-> Y
      # 1. Back-door path: D <-(+)- Z -(+)-> Y (back-door path) 
...
####################
    ...
    #Paths between the Variables D & Y
      # Causal path: D -(+)-> Y
      # 1. Back-door path: D <-(+)- Z1 -(+)-> Z2 -(+)-> Y (back-door path)
...
####################
    ...
    #Paths between the Variables D & Y
      # Causal path: D -(+)-> Y
      # 1. Back-door path: D <-(+)- Z1 -(+)-> Z2 -(+)-> Z3 -(-)-> Y (1. back-door path)  
      # 2. Back-door path: D <-(+)- Z1 -(+)-> Z2 -(-)-> Z4 -(-)-> Y (2. back-door path)  
...
####################
    ...
    #Paths between the Variables D & Y
      # Causal path: D -(+)-> M -(+) -> Y (true effekt: 2*0,5=1)
...
####################
      ...
      #Paths between the Variables D & Y
        # Causal path: D -(+)-> M -(+) -> Y (true effekt: 2*0,5=1)
        # Path between M&Y: M <-(-)- Z -(-)-> Y (back-door path for M->Y but not for D->Y)
...
####################
  ...
  # Don't interpret other beta coefficients then the one of the main effect !
        ...
        #Paths between the Variables D & Y
          # Causal path: D -(+)-> M -(+) -> Y (true effekt: 2*0,5=1)
          # 1. Back-door path: D <-(-)- Z1 -(-)-> Y
          # X1&Y Back-door path: Z1 <-(+)- Z2 -(-)-> Y
          
            # -> Estimate Z1->Y biased (with & without control for Z2) 
