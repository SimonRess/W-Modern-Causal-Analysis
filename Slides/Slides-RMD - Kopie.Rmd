...
**Syntax:** *map(data, FUN)* In pipes: *. %\>% map(\~ FUN)* \| *. %\>% map(function(x) FUN)*
...
[Tilde Operator]<https://rdrr.io/r/base/tilde.html> [Assignment Operators]<https://rdrr.io/r/base/assignOps.html> [Arithmetic Operators](https://rdrr.io/r/base/Arithmetic.html) [Colon Operator](https://rdrr.io/r/base/Colon.html) [Relational Operators](https://rdrr.io/r/base/Comparison.html) [Logical Operators](https://rdrr.io/r/base/Logic.html) [Double Colon and Triple Colon Operators](https://rdrr.io/r/base/ns-dblcolon.html) [Operators on the Date Class](https://rdrr.io/r/base/Ops.Date.html) [Operator Syntax and Precedence](https://rdrr.io/r/base/Syntax.html)
